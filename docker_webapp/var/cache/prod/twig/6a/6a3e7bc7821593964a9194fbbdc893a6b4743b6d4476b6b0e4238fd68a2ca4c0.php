            ...
            if ((($context["showTeamSubmissions"] ?? null) || ($context["jury"] ?? null))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["problem"]) {
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context["matrixItem"] ?? null), "isCorrect", [], "any", false, false, false, 233)) {
                        ...
                        // line 238
                        echo "                    ";
                    } elseif (twig_get_attribute($this->env, $this->source, ($context["matrixItem"] ?? null), "partial", [], "any", false, false, false, 238)) {
                        // line 239
                        echo "                        ";
                        $context["scoreCssClass"] = "score_partial";
                        // line 240
                        echo "                    ";
...
";
    ...
    ";
            ...
            if ((($context["showTeamSubmissions"] ?? null) || ($context["jury"] ?? null))) {
                // line 331
                echo "        ";
                $context["cellColors"] = ["first" => "-- first", "correct" => "Solved", "partial" => "Partial solved", "incorrect" => "Tried, incorrect", "pending" => "Tried, pending", "neutral" => "Untried"];
                // line 332
